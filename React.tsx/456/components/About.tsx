...
const useStyles = makeStyles((theme) => ({
    ...
    container: {
        display: 'flex',
        flexWrap: 'wrap', // This ensures that both elements wrap if needed
    },
    paperContainer: {
        flex: 1, // This makes the Paper component take up available space
...
export default function About() {
    ...
    return (
        <div className={classes.container}>
            <Paper elevation={3} className={`${classes.root} ${classes.paperContainer}`}>
