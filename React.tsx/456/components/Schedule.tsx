...
export default function ColumnSpanningDerived() {
  ...
  return (
    ...
    <div style={{ marginTop: '5%', width: '100vh !important', display: 'grid', gridTemplateColumns: '25% 75%' }}>
      {error && (
      ...
      <div>
        ...
        {!error && selectedDate && (
          <div style={{ marginTop: '8% ', backgroundColor: 'white', height: '90vh', padding: '3px', overflowY: 'auto' }}>
            <div>
              {!error && (
                <Button>
