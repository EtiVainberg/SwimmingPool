...
//     textField.innerText = "http://127.0.0.1:5173/"; // הלינק שברצונך להעתיק
...
function Home() {
    ...
    const [showModal, setShowModal] = useState(false);
    const [isManager, setIsManager] = useState<boolean>(false);
    const [showAccountMenu, setShowAccountMenu] = useState(GetCookie() ? true : false);
    ...
    return (
        <Fragment>
            ...
            <Outlet />
             <Dialog open={false} onClose={() => setShowModal(false)} maxWidth="xs" fullWidth>
