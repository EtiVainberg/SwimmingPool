...
import f4 from '../assets/SwimmingPool/water-droplets-blue-water-drops-splashes-drop-water-close-up-blue-water-drop-macro-1024x596.jpg'
import f5 from '../assets/SwimmingPool/DreamShaper_v7_Background_of_blue_water_with_shifts_and_bubble_0.jpg'

const images = [f, f1, f2, f3, f4, f5]
